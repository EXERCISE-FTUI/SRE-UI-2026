...
export default function About() {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      {/* --- CONTENT CONTAINER --- */}
      <div className="relative z-20 w-full max-w-5xl mx-auto px-6 py-20 flex flex-col gap-16 text-[#1b4f43]">
        
        {/* --- CORE VALUES SECTION (Moved to Top) --- */}
        <div className="flex flex-col items-center md:flex-row md:items-start gap-6 w-full">
          <h2 
            className="text-4xl font-bold italic whitespace-nowrap text-center md:text-left"
