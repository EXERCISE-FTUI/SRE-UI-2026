    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-4 md:p-6 lg:p-[5%]">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 lg:gap-4">
          ...
          <Link href={href}>
            <button className="bg-[#FBD100] text-[#1F6444] font-['Open_Sans'] font-bold text-sm md:text-lg lg:text-xl 2xl:text-[45px] px-4 md:px-6 lg:px-8 2xl:px-12 py-2 md:py-3 lg:py-4 rounded-full hover:opacity-90 transition-opacity whitespace-nowrap w-fit">
              Read Now
            </button>
          </Link>
        </div>
